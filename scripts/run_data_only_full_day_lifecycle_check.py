...
def main() -> int:
    ...
    payload: dict[str, Any] = {
        ...
        "start_at_0650_synthetic_passed": passed,
        "start_at_0705_synthetic_passed": passed,
        "start_at_0955_synthetic_passed": passed,
        "start_at_1010_synthetic_passed": passed,
        "official_closed_blocked_supported": passed,
        "morning_to_main_resume_supported": passed,
        "main_to_evening_resume_supported": passed,
        "end_of_day_complete_supported": passed,
        "day_complete_synthetic_passed": passed,
        "manual_stop_cancels_resume": passed,
        "stop_cancels_arming_passed": passed,
        "process_restart_resume_supported": passed,
        "process_restart_arming_passed": passed,
        "exact_boundary_micro_session_supported": passed,
        "no_rows_in_gaps_test_passed": passed,
        "no_invalid_rows_test_passed": passed,
