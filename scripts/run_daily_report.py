...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build one daily analytics report.")
    ...
    with database.session_scope() as session:
        ...
        print(json.dumps(service.daily_read_model(report), ensure_ascii=False, indent=2))
